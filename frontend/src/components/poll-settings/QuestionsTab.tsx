        ...
        <div className="flex space-x-3">
          {permissions.canEdit && (
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gray-600 hover:bg-gray-700 transition-colors duration-200 cursor-pointer"
            >
          ...
          {editingQuestion && permissions.canEdit && (
            <button
              ...
              disabled={saving}
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-primary-600 hover:bg-primary-700 transition-colors duration-200 disabled:opacity-50 cursor-pointer"
            >
